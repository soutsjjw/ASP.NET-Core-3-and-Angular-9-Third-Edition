...
namespace WorldCities.Data
{
    ...
    {
        public ApiResult(List<T> data, int count, int pageIndex, int pageSize, string sortColumn, string sortOrder)
        {
            Data = data;
            PageIndex = pageIndex;
            PageSize = pageSize;
        ...
        /// <summary>
        /// Check if teh given property name exists to protect against SQL injection attacks
        /// </summary>
